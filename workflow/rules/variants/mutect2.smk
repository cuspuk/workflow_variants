...
rule mutect2__replace_read_groups:
    ...
    wrapper:
        "v5.0.1/bio/picard/addorreplacereadgroups"
...
rule mutect2__gatk_learn_read_orientation_model:
    ...
    wrapper:
        "v5.0.1/bio/gatk/learnreadorientationmodel"
...
rule mutect2__filter_calls:
    ...
    params:
        ...
        java_opts="",
    wrapper:
        "v5.0.1/bio/gatk/filtermutectcalls"
