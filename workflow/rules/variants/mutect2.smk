...
rule mutect2__bed_to_interval_list:
    ...
    wrapper:
        "v7.2.0/bio/picard/bedtointervallist"
...
rule mutect2__gatk_learn_read_orientation_model:
    ...
    wrapper:
        "v7.2.0/bio/gatk/learnreadorientationmodel"
...
rule mutect2__filter_calls:
    ...
    params:
        ...
        java_opts="",
    wrapper:
        "v7.2.0/bio/gatk/filtermutectcalls"
